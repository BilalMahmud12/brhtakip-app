...
const CreateOrUpdateForm: React.FC<CreateOrUpdateFormProps> = (props) => {
    ...
    const [brandOptionsList, setBrandOptionsList] = useState<{ value: string, label: string }[]>([]);
    ...
    const handleOnClientSelect = (option: { value: string, label: string }, reason: string) => {
        ...
        setBrandOptionsList(reason === 'clear' ? [{ value: '', label: '' }] : [...getBrandsList(option.value)]);
    }
                        ...
                        <div className='grid grid-cols-1 lg:grid-cols-3 gap-x-6 gap-y-8 mb-4'>
                            ...
                            <div className='input-group w-full col-span-2 lg:col-span-1'>
                                ...
                                <AutoComplete
                                    ...
                                    handleOnChange={(option) => dispatch(
                                        handleFormChange({ 
                                            key: 'requestDetails.requestMaterialId', 
                                            value: option?.value as string || '' 
                                        })
                                    )}
                                />
                            ...
                            <div className='input-group w-full col-span-3 lg:col-span-1'>
                                ...
                                <Stack direction="row" spacing={1}>
                                    <Switch
                                        id="branded"
                                        checked={requestFormRef.current.branded}
                                        onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
                                            dispatch(handleFormChange({
